...
// تم إلغاء نظام VERSION المسبب للحذف التلقائي
// الآن البيانات ستبقى محفوظة دائماً ولا تحذف إلا يدوياً من الإعدادات
...
export const getStoredProducts = (): Product[] => {
  ...
  // إذا لم توجد أي منتجات نهائياً (أول مرة يفتح فيها المتجر)، نضع المنتجات الافتراضية
  if (!stored) {
